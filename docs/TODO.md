...
- [ ] **위젯 갤러리 육안 (1.15.0)** — 데스크톱 우클릭 "위젯 편집" → 검색 "Relay" → 3종 추가 표시·탭 딥링크 확인 (가이드 §1·§5 · `PLAN_widget` §5)
