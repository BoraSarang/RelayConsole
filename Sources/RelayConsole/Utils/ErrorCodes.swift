...
enum ErrorCode: String, Error {
    ...
    case filesListFailed = "E-MAC-ADB-0004"
    case filesPullFailed = "E-MAC-ADB-0005"
    case filesPushFailed = "E-MAC-ADB-0006"
    ...
    var koMessage: String {
        ...
        case .filesListFailed: return "폴더 목록을 읽어오지 못했습니다. 기기 연결을 확인해 주세요."
        case .filesPullFailed: return "파일 가져오기에 실패했습니다. 저장 공간과 권한을 확인해 주세요."
        case .filesPushFailed: return "파일 전송에 실패했습니다. 저장 공간과 권한을 확인해 주세요."
